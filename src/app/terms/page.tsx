      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-8">
          <p className="text-gray-700 mb-4">
            Our Terms and Conditions (hereinafter, &quot;T&C&quot;) constitute a
            legally binding agreement between Farm Home Life (hereinafter,
            &quot;Us&quot;, &quot;We&quot; or &quot;Our&quot;) and you
            (hereinafter, &quot;User,&quot; &quot;Users,&quot; &quot;your,&quot;
            or &quot;yours&quot;). Your use of our App shall be governed by the
            following T&C.
          </p>
          <p className="text-gray-700 mb-4">
            If you are a child under 13 years old (or such greater age required
            in your country or territory for you to be authorized to register
            for and use our App without parental approval), you are allowed to
            use our App only after your parent or guardian has red and accepted
            these T&C for you.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            support@farmhomelife.com. You agree to receive for security reasons
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            necessary to keep our App functional for you.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            ...
            subscription will depend on the subscription plan you choose.
          </p>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            <li>
              ...
              whatsoever you are in any case requested to state so, even if you
              plan to use our App for non-commercial purposes;
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            ...
            <li>
              ...
              otherwise any other illegal and/or discriminatory Content on our
              App;
            </li>
            <li>
              use our App for any illegal or unauthorized purpose. International
              Users agree to comply with all local laws regarding online conduct
          ...
          <p className="text-gray-700 mb-4">
            You are the solely responsible for any activity that occurs under
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            described in these Terms and Conditions or our Privacy Policy.
          </p>
          <p className="text-gray-700 mb-4">
            ...
            . By using our App, you agree to be bound by our Privacy Policy,
            which is incorporated into these T&C. Please be advised the Site is
            hosted in the United States. If you access the Site from the USA,
            Canada, EU, Asia, or any other region of the world with laws or
            other requirements governing personal data collection, use, or
            disclosure that differ from applicable laws in United States, then
            through your continued use of the Site, you are transferring your
            data to United States, and you expressly consent to have your data
            transferred to and processed in United States. If you do not agree
            ...
            Privacy Protection Act and EU GDPR Reg. 679/2016 recitals 38 and 58,
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4 uppercase">
            ...
            OF FARM HOME LIFE WILL BE LIMITED TO THE FULLEST EXTENT PERMITTED BY
            APPLICABLE LAW.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            You agree to defend, indemnify, and hold harmless Farm Home Life
            ...
            following: (a) your access to or use of our Services, including
            information provided in connection therewith; (b) your breach or
            alleged breach of our Terms; or (c) any misrepresentation made by
            you.
          </p>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            contact us by email at support@farmhomelife.com or by any other
            available method available in the CONTACT US section.
          </p>
          <p className="text-gray-700 mb-4">
            Farm Home Life has further committed to refer unresolved privacy
            complaints under the EU-US Privacy Shield Principles and the
            ...
            National Programs. If you do not receive timely acknowledgment of
            your complaint, or if your complaint is not satisfactorily
            ...
            provided at no cost to you. Please do not submit GDPR complaints to
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            we provide the App &quot;as-is&quot; without any warranty of any
            kind, express or implied, and to the maximum extent permitted by
            Applicable law. We disclaim all warranties, whether express,
            implied, or statutory, including but not limited to, warranties of
            merchantability, fitness for a particular purpose, title, quiet
            enjoyment, accuracy, and non-infringement. We do not guarantee any
            specific results from the use of our App. We make no warranty that
            the App shall be uninterrupted, free of viruses, or other harmful
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            Sale of Goods shall not apply to this T&C. Any notice to you may be
            provided by email to the address you have registered with us. We
            shall have no responsibility to provide maintenance or support
            services with respect to the App.
          </p>
          <p className="text-gray-700 mb-4">
            If any provision of this T&C is unenforceable, such provision shall
          ...
          <p className="text-gray-700 mb-4">
            ...
            included this T&C. Any waiver or failure by Farm Home Life to
            enforce any provision of this T&C on one occasion shall not be
          ...
          <p className="text-gray-700 mb-4">
            ...
            intellectual properties of Farm Home Life , that any actual or
            threatened breach of any section of this T&C that may constitute
            irreparable harm to Farm Home Life shall be liable to any and every
            damages, including but not limited to, incidental damages,
            consequential damages, nominal damages, liquidated damages, punitive
            damages, monetary or any special kind of damages permitted by
            applicable laws, as an appropriate remedy for such breach. This T&C
            and the Terms constitute the final, complete, and exclusive
            agreement between the parties regarding the App and supersede all
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            For any questions or queries regarding this Terms and Conditions,
